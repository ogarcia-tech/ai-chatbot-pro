...
class AICP_Ajax_Handler {
    ...
    public static function handle_chat_request() {
        ...
        // Se obtiene la última pregunta del usuario para buscar contexto.
        $last_user_message = end($history)['content'] ?? '';
        
        // Se aplica un filtro para que el addon PRO pueda inyectar contexto.
        // Por defecto, el contexto estará vacío.
        ...
        if (!empty($rag_context)) {
            ...
            $system_prompt_parts[] = "Responde a las preguntas del usuario basándote ESTRICTAMENTE en el contexto de la base de datos proporcionado. Si la información no está en el contexto, indica amablemente que no tienes esa información.";
        }
